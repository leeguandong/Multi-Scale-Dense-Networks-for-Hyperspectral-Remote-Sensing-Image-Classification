...
from Utils import zeroPadding, normalization, doPCA, modelStatsRecord, averageAccuracy, MSDNet_IN, cnn_3D_IN, \
    densenet_IN
import os
...
# 调用设计好的模型
def model_MSDNet():
    model_dense = MSDNet_IN.ResnetBuilder.build_resnet_8((1, img_rows, img_cols, img_channels),
                                                         nb_classes)
...
# 加载数据
# 修正的Indian pines数据集
mat_data = sio.loadmat('F:/transfer code/Tensorflow  Learning/3D-MSDNet/datasets/IN/Indian_pines_corrected.mat')
data_IN = mat_data['indian_pines_corrected']
# 标签数据
mat_gt = sio.loadmat('F:/transfer code/Tensorflow  Learning/3D-MSDNet/datasets/IN/Indian_pines_gt.mat')
...
for index_iter in range(ITER):
    ...
    best_weights_MSDNet_path = 'F:/transfer code/Tensorflow  Learning/3D-MSDNet/models-in-13-514-5-1/Indian_best_3D_MSDNet_' + str(
        index_iter + 1) + '.hdf5'
...
modelStatsRecord.outputStats(KAPPA_3D_MSDNet, OA_3D_MSDNet, AA_3D_MSDNet, ELEMENT_ACC_3D_MSDNet,
                             ...
                             'F:/transfer code/Tensorflow  Learning/3D-MSDNet/records-in-13-514-5-1/IN_train_3D.txt',
                             'F:/transfer code/Tensorflow  Learning/3D-MSDNet/records-in-13-514-5-1/IN_train_3D_element.txt')
