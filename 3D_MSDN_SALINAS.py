...
from Utils import zeroPadding, normalization, doPCA, modelStatsRecord, averageAccuracy, MSDN_SA
...
# 调用设计好的模型
def model_MSDNet():
    model_dense = MSDN_SA.ResnetBuilder.build_resnet_8((1, img_rows, img_cols, img_channels),
                                                       nb_classes)
...
for index_iter in range(ITER):
    ...
    best_weights_MSDNet_path = 'F:/transfer code/Tensorflow  Learning/3D-MSDNet/models-sa-17-514-5-2/sa_best_3D_MSDNet_' + str(
        index_iter + 1) + '.hdf5'
...
modelStatsRecord.outputStats(KAPPA_3D_MSDNet, OA_3D_MSDNet, AA_3D_MSDNet, ELEMENT_ACC_3D_MSDNet,
                             ...
                             'F:/transfer code/Tensorflow  Learning/3D-MSDNet/records-sa-17-514-5-1/IN_train_3D.txt',
                             'F:/transfer code/Tensorflow  Learning/3D-MSDNet/records-sa-17-514-5-1/IN_train_3D_element.txt')
