...
mat_data = sio.loadmat('F:/transfer code/Tensorflow  Learning/3D-MSDNet/datasets/Botswana/Botswana.mat')
data_IN = mat_data['Botswana']
mat_gt = sio.loadmat('F:/transfer code/Tensorflow  Learning/3D-MSDNet/datasets/Botswana/Botswana_gt.mat')
...
for index_iter in range(ITER):
    ...
    best_weights_MSDNet_path = 'F:/transfer code/Tensorflow  Learning/3D-MSDNet/models-botswana-13-514-5/Indian_best_3D_MSDNet_' + str(
        index_iter + 1) + '.hdf5'
