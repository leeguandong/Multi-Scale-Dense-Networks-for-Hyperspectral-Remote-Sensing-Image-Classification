...
for index_iter in range(ITER):
    ...
    best_weights_MSDNet_path = 'F:/transfer code/Tensorflow  Learning/3D-MSDNet/models-in-19-514-5-1/Indian_best_3D_MSDNet_' + str(
        index_iter + 1) + '.hdf5'
...
modelStatsRecord.outputStats_assess(KAPPA_3D_MSDNet, OA_3D_MSDNet, AA_3D_MSDNet, ELEMENT_ACC_3D_MSDNet,
                                    CATEGORY,
                                    'F:/transfer code/Tensorflow  Learning/3D-MSDNet/records-in-19-514-5-1/IN_test_3D.txt',
                                    'F:/transfer code/Tensorflow  Learning/3D-MSDNet/records-in-19-514-5-1/IN_test_element_3D.txt')
