...
import time
import os
from Utils import zeroPadding, normalization, doPCA, modelStatsRecord, averageAccuracy, MSDNet_UP
...
for index_iter in range(ITER):
    ...
    best_weights_DenseNet_path = 'F:/transfer code/Tensorflow  Learning/3D-MSDNet/models-up-13-217-7-1/UP_best_3D_MSDNet_' + str(
        index_iter + 1) + '.hdf5'
