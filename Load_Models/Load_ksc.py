...
mat_data = sio.loadmat('F:/transfer code/Tensorflow  Learning/3D-MSDNet/datasets/ksc/KSC.mat')
data_IN = mat_data['KSC']
mat_gt = sio.loadmat('F:/transfer code/Tensorflow  Learning/3D-MSDNet/datasets/ksc/KSC_gt.mat')
gt_IN = mat_gt['KSC_gt']
print(data_IN.shape)
...
for index_iter in range(ITER):
    ...
    best_weights_MSDNet_path = 'F:/transfer code/Tensorflow  Learning/3D-MSDNet/models-ksc-19-217-7/ksc_best_3D_MSDNet_' + str(
        index_iter + 1) + '.hdf5'
...
modelStatsRecord.outputStats_assess(KAPPA_3D_MSDNet, OA_3D_MSDNet, AA_3D_MSDNet, ELEMENT_ACC_3D_MSDNet,
                                    CATEGORY,
                                    'F:/transfer code/Tensorflow  Learning/3D-MSDNet/records-ksc-19-217-7/IN_test_3D.txt',
                                    'F:/transfer code/Tensorflow  Learning/3D-MSDNet/records-ksc-19-217-7/IN_test_element_3D.txt')
