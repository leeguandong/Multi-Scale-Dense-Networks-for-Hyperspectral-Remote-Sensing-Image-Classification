...
for index_iter in range(ITER):
    ...
    best_weights_MSDNet_path = 'F:/transfer code/Tensorflow  Learning/3D-MSDNet/models-ksc-13-514-5/ksc_best_3D_MSDNet_' + str(
        index_iter + 1) + '.hdf5'
...
modelStatsRecord.outputStats(KAPPA_3D_MSDNet, OA_3D_MSDNet, AA_3D_MSDNet, ELEMENT_ACC_3D_MSDNet,
                             ...
                             'F:/transfer code/Tensorflow  Learning/3D-MSDNet/records-ksc-13-514-5/IN_train_3D.txt',
                             'F:/transfer code/Tensorflow  Learning/3D-MSDNet/records-ksc-13-514-5/IN_train_3D_element.txt')
