...
class ResnetBuilder(object):
    @staticmethod
    def build(input_size, nb_classes=9, scale=3, depth=3, l_growth_rate=(6, 12, 24),
              transition_block_location=(12, 20), classifier_ch_nb=128, classifier_location=(3,)):
        """
...
def main():
    model = ResnetBuilder.build_resnet_8((1, 17, 17, 200), 9)
